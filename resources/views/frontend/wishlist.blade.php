        ...
        <div class="card-body">
            ...
            <div class="card-body ">
                ...
                <div class="row p-2  product_data">
                    ...
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-success addToCartBtn float-start me-2"> <i
                                class="fa fa-shopping-cart"></i> Add to Cart</button>
                        <button type="submit" class="btn btn-danger remove-wish-list"> <i class="fa fa-remove"></i>
                            Remove</button>
                    </div>
                </div>
                <hr>
