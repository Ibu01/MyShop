        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 border-right">
                    <img style="height: 300px" src="{{ asset('assets/uploads/products/'.$products->image) }}"
                        class="w-100" alt="">
                </div>
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        <label style="font-size: 16px;" class="float-end badge bg-danger trending_tag"
                            for="">{{ $products->trending == '1'? 'Trending':'' }}</label>
                    </h2>
                    <hr>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-10 mt-2">
                            ...
                            @if($products->qty > 0)
                            <button type="submit" class="btn btn-primary me-3 addToCartBtn float-start">Add to Cart <i
