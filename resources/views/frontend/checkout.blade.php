                        ...
                        <div class="row checkout-form">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ Auth::user()->address1 }}"
                                    name="address1" placeholder="Enter Your Address 1">
                            </div>
                            <div class="col-md-6 mt-3">
                                <label for="">Address 2</label>
                                <input type="text" class="form-control" value="{{ Auth::user()->address2 }}"
                                    name="address2" placeholder="Enter Your Address 2">
                            </div>
                            <div class="col-md-6 mt-3">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ Auth::user()->zip }}" name="zip"
